        ...
        <div>
            ...
            >
                ...
                <p className="text-white itc text-3xl max-w-3xl mx-auto my-20 light">
                    Founded in 1911 as a cocoa pressing plant on the banks of
                    the Zaan River in the Netherlands, deZaan has spent more
                    than a century setting the standards for cocoa ingredient
                    excellence.
                </p>
            ...
            <div className="py-8">
                <div className="flex items-stretch py-8 ">
                    <div className="w-full px-14 h-full">
                        ...
                        <p className="text-blue itc text-2xl mt-16 light">
                            We bring precision and passion to every part of the
                            cocoa process - we select only the finest cocoa
                            beans, harness proprietary processing techniques and
                            utilise our long-held knowledge to offer a complete
                            set of cocoa ingredients to our customers.
                        </p>
                    </div>
                    <div className="w-full">
                        <img
                            className="w-full h-auto"
                            src="https://images.ctfassets.net/yn1b2kwt1vbo/11Iiyo0iivN4NwBSbpEMZO/5275cc1c657ea5627b6195b3a3cd0252/J1048_OC_Amsterdam_1028.png?w=1000&h=750&q=80&fm=webp"
                        />
                    </div>
                </div>
                <div className="flex items-center py-8 ">
                    <div className="w-full p-14 pr-0">
                        <img
                            className="w-full h-auto"
                            src="https://images.ctfassets.net/yn1b2kwt1vbo/5vjqEy8F2hOAMFxRgAwM8S/12698992cb414cca34f011de4ce06c05/Rectangle_2592.png?w=666&h=482&q=80&fm=webp"
                        />
                    </div>
                    <div className="w-full px-14 h-full">
                        <p className="text-blue itc text-2xl light max-w-md">
                            At the heart of our approach is a desire to share
                            the vast potential of cocoa with the world. Our
                            cocoa powders are renowned for their variety and
                            quality, with colours that range from red to brown
                            and black, across low and high-fat contents and
                            natural and dutched variations. Together, our cocoa
                            powders represent the full range of flavours,
                            colours and textures that cocoa has to offer.
                        </p>
                    </div>
                </div>
                <div className="flex items-stretch py-8 ">
                    <div className="w-full px-14 h-full">
                        ...
                        <p className="text-blue itc text-2xl mt-16 light">
                            With all of our cocoa powders, cocoa butters and
                            cocoa liquors, we always seek to find new ways to
                            meet our customers{"'"} needs, while never
                            compromising on the high-quality and consistency for
                            which we are known. Today, we are proud to be the
                            partner of choice for chocolate confectionery
                            manufacturers and kitchen professionals everywhere.
                        </p>
                    </div>
                    <div className="w-full">
                        <img
                            className="w-full h-auto"
                            src="https://images.ctfassets.net/yn1b2kwt1vbo/69sN1rE1VQRBVPSdNk9c61/251131f58848015dc50a5d23a12f1472/Rectangle_2590.png?w=1000&h=718&q=80&fm=webp"
                        />
                    </div>
                </div>
                <div className="flex items-stretch py-8 ">
                    <div className="w-full p-14 pr-0">
                        <img
                            className="w-full h-auto"
                            src="https://images.ctfassets.net/yn1b2kwt1vbo/2PNpwfi0Kg5ReotCMqyv2v/3d4bd529d7add9a257fd6ce0335251ec/dezaan-sustainability.jpg?w=682&h=719&q=90&fm=webp"
                        />
                    </div>
                    <div className="w-full p-14 h-full">
                        ...
                        <p className="text-blue itc text-2xl mt-16 light max-w-md">
                            Setting the standard for cocoa excellence starts
                            with the cocoa beans we source. We make sure that as
                            well as being of the highest quality and flavour,
                            our cocoa is sourced responsibly in a way that is
                            good for smallholder farmers, their families and
